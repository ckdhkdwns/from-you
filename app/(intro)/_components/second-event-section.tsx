...
export default function SecondEventSection() {
    return (
        <div className="space-y-2">
            {/* <div className="text-xs text-secondary-fuchsia">EVENT</div>
            ...
            <Card className="p-6 md:p-8 md:h-[220px] relative items-center flex bg-primary-pink/50 rounded-md border-none shadow-none">
                <div className="flex justify-between items-center gap-8">
                    ...
                    <div className="space-y-6  z-10">
                        <div className="space-y-1.5">
                            <div className="space-y-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-2xl md:text-3xl font-bold text-secondary-mutered">
                                        3,000 포인트
                                    </span>
                        ...
                        <div className="flex items-center gap-1">
                            <p className="text-base text-[#131200]">리뷰 작성하러 가기</p>
                            <Image
